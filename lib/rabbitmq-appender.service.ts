...
export class RabbitmqAppenderService {
  ...
  info(message, context, meta?) {
    this.producer.send(this.createMessage(LogLevel.INFO, message, context, meta));
  }

  warn(message, context, meta?) {
    this.producer.send(this.createMessage(LogLevel.WARN, message, context, meta));
  }

  error(message, context, meta?) {
    this.producer.send(this.createMessage(LogLevel.ERROR, message, context, meta));
  }
